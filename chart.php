...
?>
<?php 
$qry="select * from `game_result_date` where `gid`='$_GET[gid]'  order by `date` desc";
...
$qrtg="select * from `game2` where `id`='$_GET[gid]'";
...
<br>
<style>
    body {background-image: linear-gradient(to right top, #000000, #200e12, #38141b, #511821, #6b1c24, #6b1c24, #6b1c24, #6b1c24, #511821, #38141b, #200e12, #000000);}    
...
<img height="100" style="margin-bottom: -15px; margin-top: -8px;" src="images/logo.webp" alt="satta"> 
</div>
...
<br> </div> <div style="border-style: double; border-color: #0000ff; background-color: #ffffff; color: #000000; " align="center"><big> <br /> <h2><?php echo $rowg['game_name']; ?> </h2> <table width="auto" cellspacing="0" cellpadding="4" border="1" bgcolor="white">
		  ...
		  if($nameOfDay=="Tue"){
		    ...
		    if($nameOfDay=="Wed"){
		      ...
		      if($rowd['mval']==""){ $fri="**";} else {$fri=$rowd['mval']; } }
		       ...
		       if (in_array($fri,$fri_arr)){ $fricls="red"; }else {$fricls="black"; }
